...
module "my_web_vpc" { ## We could call this "pepe" :-)
  ...
  source = "github.com/raquelsanzseg/tfcourse-modules//web-modules/aws-web-vpc?ref=v1.0.3"
...
module "web1" {
  ...
  source            = "github.com/raquelsanzseg/tfcourse-modules//web-modules/aws-web-server-instance?ref=v1.0.3"
