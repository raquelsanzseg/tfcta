...
module "vpc_proj2" {
  ...
  source            = "github.com/raquelsanzseg/tfcourse-modules//web-modules/aws-web-vpc"
...
module "web_proj2" {
  ...
  source            = "github.com/raquelsanzseg/tfcourse-modules//web-modules/aws-web-server-instance"
  os                = var.server_os
